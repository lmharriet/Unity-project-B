...
public class CamRotate : MonoBehaviour
{
    ...
    private void Rotate()
    {
        ...
        //우리가 회전처리를 제어하기 힘들다
        //인스펙터창의 로테이션값은 사용자가 보기 편하도록 편의를 위해서
        //오얼러각도(0도~360도)로 표시되지만
        //내부적으로 쿼터니언으로 회전처리가 되고 있다
        //쿼터니언을 사용하는 이유는 짐벌락현상을 방지할 수 있기 때문에 사용한다

        //회전을 직접 제어 할때는 Rotate 함수를 사용하지 않고
        ...
        //위 코드에는 다른 문제가 있다
        //유니티 엔진 내부적으로 - 각도는 360도를 더해서 처리된다
